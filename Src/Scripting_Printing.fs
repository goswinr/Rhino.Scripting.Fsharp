...
module AutoOpenPrinting =
  ...
  type RhinoScriptSyntax with
    ...
    /// Like printf but in Red if used from Fesh F# Scripting Editor. Does not add a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.
    ...
    /// Like printfn but in Red if used from Fesh F# Scripting Editor. Adds a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.
    ...
    /// Like printfn but in Green if used from Fesh F# Scripting Editor. Adds a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.
    ...
    /// Like printf but in Light Blue if used from Fesh F# Scripting Editor. Does not add a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.
    ...
    /// Like printfn but in Light Blue if used from Fesh F# Scripting Editor. Adds a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.
    ...
    /// Like printf but in Blue if used from Fesh F# Scripting Editor. Does not add a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.
    ...
    /// Like printfn but in Blue if used from Fesh F# Scripting Editor. Adds a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.
    ...
    /// Like printf but in Gray if used from Fesh F# Scripting Editor. Does not add a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.
    ...
    /// Like printfn but in Gray if used from Fesh F# Scripting Editor. Adds a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.
    ...
    ///<summary>Like printf but in custom color if used from Fesh F# Scripting Editor. Does not add a new line at end.
    ...
    ///<summary>Like printfn but in custom color if used from Fesh F# Scripting Editor. Adds a new line at end.
    /// Prints to Console.Out and to Rhino Commandline.</summary>
    ///<param name="red">(int) Red Value between 0 and 255 </param>
    ///<param name="green">(int) Green value between 0 and 255 </param>
    ///<param name="blue">(int) Blue value between 0 and 255 </param>
